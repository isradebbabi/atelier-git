...
$ListDestination = $des1->listDestination(); // Assuming this method exists and returns a list of destinations
$ListDestination2 = $des1->list_Destination1(); // Assuming this method exists and returns a list of destinations
