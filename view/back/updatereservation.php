        ...
        if (isset($_POST["submit"])) {
            if (
                ...
                if (
                    ...
                    !empty($_POST['participation']) &&
                    !empty($_POST['prix']) &&
                    !empty($_POST['statu']) &&
                    !empty($_POST['pay_meth'])
                ) {
...
<div class="container-fluid py-4">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">update reservation</p>
    ...
    <input type="text" id="id_res" name="id_res" value="<?php echo isset($reservation['id_res']) ? $reservation['id_res'] : ''; ?>">
    ...
    <input type="text" id="id_user" name="id_user" value="<?php echo isset($reservation['id_user']) ? $reservation['id_user'] : ''; ?>">

    <br>
    </div>
    <div class="form-group">
    <!-- id_heb Input -->
    <label for="id_heb">id_heb:</label>
    <input type="text" id="id_heb" name="id_heb" value="<?php echo isset($reservation['id_heb']) ? $reservation['id_heb'] : ''; ?>">

    <br>
    </div>
    <div class="form-group">
    <!-- id_voy Input -->
    <label for="id_voy">id_voy:</label>
    <input type="text" id="id_voy" name="id_voy" value="<?php echo isset($reservation['id_voy']) ? $reservation['id_voy'] : ''; ?>">
...
<input type="date" id="date_res" name="date_res" value="<?php echo isset($reservation['date_res']) ? $reservation['date_res'] : ''; ?>">
    <br>
    </div>
    <div class="form-group">
    <!-- participation Input -->
    <label for="participation">Participation:</label>
    <input type="text" id="participation" name="participation" value="<?php echo isset($reservation['participation']) ? $reservation['participation'] : ''; ?>">
    ...
    <input type="text" id="prix" name="prix" value="<?php echo isset($reservation['prix']) ? $reservation['prix'] : ''; ?>">
    ...
    <input type="text" id="statu" name="statu" value="<?php echo isset($reservation['statu']) ? $reservation['statu'] : ''; ?>">
    ...
    <input type="text" id="pay_meth" name="pay_meth" value="<?php echo isset($reservation['pay_meth']) ? $reservation['pay_meth'] : ''; ?>">
