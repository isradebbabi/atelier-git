...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="text" id="nom" name="nom" value="<?php echo $hebergement['nom']; ?>">

    <br>

    <label for="type">Type:</label>
    <input type="text" id="type" name="type" value="<?php echo $hebergement['type']; ?>">

    <br>

    <!-- Quantity Input -->
    <label for="description">Description:</label>
    <input type="text" id="description" name="description" value="<?php echo $hebergement['description']; ?>">

    <br>

    <!-- Region Input -->
    <label for="localisation">Localisation:</label>
    <input type="text" id="localisation" name="localisation" value="<?php echo $hebergement['localisation']; ?>">

    <br>
    <label for="categorie">Catégorie:</label>
    <input type="text" id="categorie" name="categorie" value="<?php echo $hebergement['categorie']; ?>">

    <br>

    <label for="service">Service:</label>
    <input type="text" id="service" name="service" value="<?php echo $hebergement['service']; ?>">
