...
<h6>
            ...
            <tbody>
                ...
                while ($res = $r->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <h6> <td>' . $res['id_res'] . '</td>
                        ...
                        <td>' . $res['pay_meth'] . '</td>
                        <td>
                            <a href="updatereservation.php?updateid=' . $res['id_res'] . '" class="btn btn-primary">Update</a>
        ...
        <div class="d-flex justify-content-center">
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                echo '<a href="?page=' . $i . '" class="btn btn-outline-primary mx-1">' . $i . '</a>';
            }
            ?>
        </div>
    </div>
...
<div class="statistics-container">
    <div class="statistics-table">
        ...
        echo "<h4>Accommodation Statistics</h4>";
