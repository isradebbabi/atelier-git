                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="404.html" class="dropdown-item">Reservation</a>
                        </div>
                    </div>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Reservation</h1>
        ...
        <div class="booking p-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-6 text-white">
                    ...
                    <p class="mb-4">Reservation Management:</p>
                    <p class="mb-4">"Streamline your travel plans with our reservation management service. Say goodbye to the hassle of coordinating bookings across multiple platforms – our centralized reservation system makes it easy to book and manage all your travel arrangements in one place. Whether you're planning a weekend getaway or a month-long adventure, our user-friendly interface allows you to seamlessly reserve accommodations, transportation, and activities with just a few clicks. Take the stress out of travel planning and let us handle the details while you focus on making memories!"</p>
    ...
    <style>
        ...
        <script>
            $(function() {
                ...
                $("#prix").val("$" + $("#slider-range").slider("values", 0) + " - $" + $("#slider-range").slider("values", 1));
            });
        </script>
